...
public interface SpringDataCotizacionJpaRepository extends JpaRepository<CotizacionJpaEntity, UUID> {
    ...
    @Query("""
            ...
            """)
    List<CotizacionJpaEntity> findActivaByEventoIdOrderByCreatedAtDesc(UUID eventoId);
    ...
    @Query("""
            ...
            order by c.createdAt desc
            """)
    List<CotizacionJpaEntity> findByEventoIdOrderByCreatedAtDesc(UUID eventoId);
